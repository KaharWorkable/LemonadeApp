...
class MainActivity : AppCompatActivity() {
    ...
    private fun pick() {
        // TODO(- The squeezeCount should be 0 since we haven't squeezed any lemons just yet.)
    ...
    private fun setViewElements() {
        ...
        lemonImage!!.setImageResource(drawableResources)
        textAction.text = textResources
